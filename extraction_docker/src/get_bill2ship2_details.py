...
if __name__ == "__main__":
    df = pd.read_csv(r"C:\Users\OVE\Downloads\doc_1652868593030_ba889b8ba8a_pred.csv",index_col = False)
    df = get_bill_to_ship_to_details(df,INDIA_ZIP_CODE_RANGE, billToNames_kws, shipToNames_kws)
    df.to_csv(r"C:\Users\OVE\Downloads\doc_1652868593030_ba889b8ba8a_pred1.csv.csv")
